  ...
  return (
    <Layout>
      ...
      <div className="mb-4 flex flex-wrap gap-3">
        <select className="rounded-md border border-gray-200 px-3 py-1.5 text-sm" value={filters.type} onChange={(e) => setFilters({ ...filters, type: e.target.value })}>
        ...
        <input placeholder="Search reg. no…" className="rounded-md border border-gray-200 px-3 py-1.5 text-sm" value={filters.search} onChange={(e) => setFilters({ ...filters, search: e.target.value })} />
        <select className="rounded-md border border-gray-200 px-3 py-1.5 text-sm" value={filters.ordering} onChange={(e) => setFilters({ ...filters, ordering: e.target.value })}>
